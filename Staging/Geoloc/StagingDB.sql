...
DELIMITER //
CREATE DEFINER=`root`@`localhost` EVENT `evtSetTrackersLastLocation` ON SCHEDULE EVERY 1 MINUTE STARTS '2016-10-01 01:03:35' ON COMPLETION NOT PRESERVE ENABLE DO CALL spSetTrackersLastLocation()//
DELIMITER ;
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` FUNCTION `ParseAddress`(
	`address` LONGTEXT,
...
CREATE TABLE IF NOT EXISTS `points` (
  ...
  `NTS` int(11) NOT NULL DEFAULT '0',
  `VehicleStatus` int(3) DEFAULT '0',
  PRIMARY KEY (`TrackerID`,`Time`),
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `spSetTrackersLastLocation`()
BEGIN
...
DELIMITER //
CREATE DEFINER=`geoloc`@`localhost` EVENT `TimeZoneControl` ON SCHEDULE EVERY 1 HOUR STARTS '2017-04-18 22:52:42' ON COMPLETION NOT PRESERVE ENABLE DO INSERT INTO Commands(TrackerID, Time, Command)
...
CREATE TABLE IF NOT EXISTS `trackergroups` (
  `ID` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `UserID` int(10) unsigned NOT NULL,
  `Name` varchar(45) NOT NULL DEFAULT 'Новая группа',
  PRIMARY KEY (`ID`),
...
CREATE TABLE IF NOT EXISTS `trackers` (
  ...
  `Name` varchar(45) NOT NULL DEFAULT 'Новый',
...
CREATE TABLE IF NOT EXISTS `trends` (
  ...
  `Name` varchar(45) NOT NULL DEFAULT 'Напряжение питания',
...
CREATE TABLE `vw_forwardrecords` (
	...
	`Device Time-Stamp (epoch)` INT(10) UNSIGNED NOT NULL COMMENT 'время',
	`Locanix-In Time-Stamp (epoch)` INT(11) NULL,
	`Locanix-Out Time-Stamp (epoch)` INT(11) NULL,
	`Network Delay` BIGINT(11) UNSIGNED NULL,
	`Locanix Delay` BIGINT(12) NULL,
	`Total Delay` BIGINT(11) UNSIGNED NULL,
	`Resend Count` INT(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zones` (
  `ID` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `Name` varchar(45) NOT NULL DEFAULT 'Зона',
  `Comment` varchar(128) NOT NULL DEFAULT 'Описание',
