...
abstract class ServerSession : Session
{
    ...
    //////////////////////////////////////////////////////////////////////
    //////////////////////////////////////////////////////////////////////
    protected override bool PushPacket(TrackerPacket packet,long imei)
    {
        long IMEI = packet.m_ID;        
        return base.PushPacket(packet,IMEI) && m_GPSQueue.SetOnline(IMEI, m_nID);
    }    
    //////////////////////////////////////////////////////////////////////
...
abstract class AsyncServer
{
    ...
    public void StopListener()
    {
        try
        {
            if (m_Listener != null)
            {
                m_Logger.Push(LogLevel.WARNING, 0, "Server " + ToString() + " was stopped");
...
abstract class AsyncUDPServer: Session
{
    ...
    public abstract override string ToString();
    //////////////////////////////////////////////////////////////////////////////////
    public AsyncUDPServer(IPAddress ipAddres, int nPort): base(Global.m_GPSQueue, null)
    {
        m_endPoint = new IPEndPoint(ipAddres, nPort);
